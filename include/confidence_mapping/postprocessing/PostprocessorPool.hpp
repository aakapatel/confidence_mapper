...
#include "confidence_mapping/postprocessing/PostprocessingWorker.hpp"
 ...
 * Workers operate on copies of the raw confidence map instead of working on the same data.
 */
